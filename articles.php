...
$query="SELECT id FROM articles WHERE id IN ( SELECT article_id 
                                            FROM lignes_commande 
                                            WHERE lignes_commande.article_id = articles.id ) 
                                OR id IN ( SELECT article_id 
                                        FROM images 
                                        WHERE images.article_id = articles.id )";
    ...
    <tbody>
        ...
        ?>
            <tr>
                ...
                <td> <?php echo $ligne["stock_disponible"]; ?> </td>
                <td>
                    <a href="modifarticle.php?id=<?php echo $ligne["id"] ?>" class="btn btn-success">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <a href="deletearticle.php?id=<?php echo $ligne["id"] ?>" class="btn btn-danger">Supprimer</a>
                        </div>
                    </div>
                </div>
            </div>
